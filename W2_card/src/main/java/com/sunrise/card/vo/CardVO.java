...
public class CardVO {
	...
	public String toString() {
		return "BoardVO [CRD_NO" + "=" + CRD_NO + ", CUST_NO"+ "=" + CUST_NO + ", MGT_BBRN"	+ "=" + MGT_BBRN
				+ ", REG_D"+ "=" + REG_D + ", SSN"	+ "=" + SSN + ", VLD_DUR"+ "=" + VLD_DUR
				+ ", BRD=" + BRD + ", SCRT_NO"+ "=" + SCRT_NO + ", ENG_NM"+ "=" + ENG_NM + ",BF_CRD_NO"	+  "=" + BF_CRD_NO + ""
				+ ", LST_CRD_F"	+ "=" + "LST_CRD_F"+ "" + "=" + FST_REG_D + "=" + FST_REG_D +", CRD_GRD" + "=" + CRD_GRD + " ]";
	}
}
